...
# Implicit wait : It applies on all the webelement of webpage
# Explicit wait : It applies on specific element of the webpage
...
Launch Browser and Search
    ...
    wait until element is visible     ${google_search_button}       15s
